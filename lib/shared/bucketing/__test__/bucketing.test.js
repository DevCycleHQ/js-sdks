...
import { FeatureType } from '@devcycle/shared/mongo/schemas'
...
describe('Rollout Logic', () => {
    ...
    it('should not pass rollout for startDates in the future', () => {
        let rollout = {
            ...
            targetDate: moment().add(2, 'days').toDate(),
            startPercentage: 0,
            targetPercentage: 1
        }
    ...
    it('should pass rollout for endDates in the past', () => {
        let rollout = {
            ...
            targetDate: moment().subtract(1, 'days').toDate(),
            startPercentage: 0,
            targetPercentage: 1
        }
        expect(doesUserPassRollout({ rollout, boundedHash: 0 })).toBeTruthy()
    ...
    it('throw when targetDate is set but startdate is not', () => {
        let rollout = {
            targetDate: moment().add(1, 'minute').toDate(),
            startPercentage: 0.5,
            targetPercentage: 1
        }
