                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_680f420d-a65f-406c-8aaf-0b39a617e696'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    dataKeyType: 'String',
                    _audiences: [],
                    values: ['E9hQ0Pqny45G', 'ysS29rBvYaXs'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_27579841-c4dd-4b81-be14-b6c8090f8758'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_ac43af96-e84a-4446-96b5-093b0f8d8d31'],
                    filters: [],
                  },
                ],
                operator: 'and',
              ...
              filters: {
                filters: [
                  ...
                  },
                  {
                    ...
                    dataKeyType: 'String',
                    _audiences: [],
                    values: ['hOwQX5sV3eMQ', 'PyPREARJvoiq', 'Wh56kpJUCtP5'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_5abf7f9c-34cd-4721-8074-9e5d0aab9839'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_5e49ebff-6a63-4935-9ea9-06696211e77f'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    type: 'audienceMatch',
                    comparator: '=',
                    _audiences: ['f4e70df027d945fb8af17bfa8dd48091'],
                    values: [],
                    filters: [],
                  },
                ],
                ...
                filters: [
                  {
                    ...
                    dataKeyType: 'String',
                    _audiences: [],
                    values: ['AXayVhoBs4iX', 'BKhAwovvP46D'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    type: 'audienceMatch',
                    comparator: '=',
                    _audiences: ['a2a331f751914200a8a53b59ae6b7a6f'],
                    values: [],
                    filters: [],
                  },
                ],
                ...
                filters: [
                  {
                    type: 'audienceMatch',
                    comparator: '=',
                    _audiences: ['e757fc6a16924b2ab5a95c00d609ab14'],
                    values: [],
                    filters: [],
                  },
                ],
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_8a834e64-50ce-4bf9-9bb1-4bacb3b3094c'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_5239eab2-74d6-4f4a-91a3-d527430ddb28'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_0dcea18c-74c0-4872-a98a-b8d67eeadfc5'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_b401a363-1198-49b4-b334-8b7e78c9002d'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    type: 'audienceMatch',
                    comparator: '=',
                    _audiences: ['b400f04e086a4e8f9ae7f68920b92fee'],
                    values: [],
                    filters: [],
                  },
                ],
                ...
                filters: [
                  {
                    type: 'audienceMatch',
                    comparator: '=',
                    _audiences: ['929a3f351a6249c68ca17133ab661ca7'],
                    values: [],
                    filters: [],
                  },
                ],
                ...
                filters: [
                  {
                    type: 'audienceMatch',
                    comparator: '=',
                    _audiences: ['7db4d6f7e53543e4a413ac539477bac6'],
                    values: [],
                    filters: [],
                  },
                  {
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_d4890258-c74a-47cb-95e7-e06e1bf37eec'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    dataKeyType: 'String',
                    _audiences: [],
                    values: ['iYI6uwZed0ip', 'QqDKIhOwJqGz'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_8767c5da-48d9-4b62-9645-c6bda3ff013b'],
                    filters: [],
                  },
                ],
                operator: 'and',
                ...
                filters: [
                  {
                    ...
                    comparator: '=',
                    _audiences: [],
                    values: ['user_8a6015f1-5b84-406e-ad04-8556709f4d2a'],
                    filters: [],
                  },
                ],
                operator: 'and',
