...
$root.ClientCustomData_PB = (function() {

    /**
     * Properties of a ClientCustomData_PB.
     * @exports IClientCustomData_PB
     * @interface IClientCustomData_PB
     * @property {Object.<string,ICustomDataValue>|null} [value] ClientCustomData_PB value
     */

    /**
     * Constructs a new ClientCustomData_PB.
     * @exports ClientCustomData_PB
     * @classdesc Represents a ClientCustomData_PB.
     * @implements IClientCustomData_PB
     * @constructor
     * @param {IClientCustomData_PB=} [properties] Properties to set
     */
    function ClientCustomData_PB(properties) {
        this.value = {};
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
    ...
    /**
     * ClientCustomData_PB value.
     * @member {Object.<string,ICustomDataValue>} value
     * @memberof ClientCustomData_PB
     * @instance
     */
    ClientCustomData_PB.prototype.value = $util.emptyObject;

    /**
     * Creates a new ClientCustomData_PB instance using the specified properties.
     * @function create
     * @memberof ClientCustomData_PB
     * @static
     * @param {IClientCustomData_PB=} [properties] Properties to set
     * @returns {ClientCustomData_PB} ClientCustomData_PB instance
     */
    ClientCustomData_PB.create = function create(properties) {
        return new ClientCustomData_PB(properties);
    };

    /**
     * Encodes the specified ClientCustomData_PB message. Does not implicitly {@link ClientCustomData_PB.verify|verify} messages.
     * @function encode
     * @memberof ClientCustomData_PB
     * @static
     * @param {IClientCustomData_PB} message ClientCustomData_PB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ClientCustomData_PB.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.value != null && Object.hasOwnProperty.call(message, "value"))
            for (var keys = Object.keys(message.value), i = 0; i < keys.length; ++i) {
    ...
    /**
     * Encodes the specified ClientCustomData_PB message, length delimited. Does not implicitly {@link ClientCustomData_PB.verify|verify} messages.
     * @function encodeDelimited
     * @memberof ClientCustomData_PB
     * @static
     * @param {IClientCustomData_PB} message ClientCustomData_PB message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ClientCustomData_PB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ClientCustomData_PB message from the specified reader or buffer.
     * @function decode
     * @memberof ClientCustomData_PB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ClientCustomData_PB} ClientCustomData_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ClientCustomData_PB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientCustomData_PB(), key, value;
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    /**
     * Decodes a ClientCustomData_PB message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof ClientCustomData_PB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ClientCustomData_PB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a ClientCustomData_PB message.
     * @function verify
     * @memberof ClientCustomData_PB
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ClientCustomData_PB.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.value != null && message.hasOwnProperty("value")) {
            if (!$util.isObject(message.value))
    ...
    /**
     * Creates a ClientCustomData_PB message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ClientCustomData_PB
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {ClientCustomData_PB} ClientCustomData_PB
     */
    ClientCustomData_PB.fromObject = function fromObject(object) {
        if (object instanceof $root.ClientCustomData_PB)
            return object;
        var message = new $root.ClientCustomData_PB();
        if (object.value) {
            if (typeof object.value !== "object")
                throw TypeError(".ClientCustomData_PB.value: object expected");
            message.value = {};
            for (var keys = Object.keys(object.value), i = 0; i < keys.length; ++i) {
                if (typeof object.value[keys[i]] !== "object")
                    throw TypeError(".ClientCustomData_PB.value: object expected");
    ...
    /**
     * Creates a plain object from a ClientCustomData_PB message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ClientCustomData_PB
     * @static
     * @param {ClientCustomData_PB} message ClientCustomData_PB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ClientCustomData_PB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.objects || options.defaults)
    ...
    /**
     * Converts this ClientCustomData_PB to JSON.
     * @function toJSON
     * @memberof ClientCustomData_PB
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ClientCustomData_PB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    /**
     * Gets the default type url for ClientCustomData_PB
     * @function getTypeUrl
     * @memberof ClientCustomData_PB
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    ClientCustomData_PB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/ClientCustomData_PB";
    };

    return ClientCustomData_PB;
})();
