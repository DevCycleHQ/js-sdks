...
$root.SDKVariable_PB = (function() {
     ...
     * @property {INullableString|null} [_feature] SDKVariable_PB _feature
     */
     ...
     * @member {INullableString|null|undefined} _feature
     * @memberof SDKVariable_PB
     * @instance
     */
    SDKVariable_PB.prototype._feature = null;
    ...
    SDKVariable_PB.encode = function encode(message, writer) {
        ...
        if (message._feature != null && Object.hasOwnProperty.call(message, "_feature"))
            $root.NullableString.encode(message._feature, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
        return writer;
    };
    ...
    SDKVariable_PB.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
            ...
            case 8: {
                    message._feature = $root.NullableString.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    SDKVariable_PB.verify = function verify(message) {
        ...
        if (message._feature != null && message.hasOwnProperty("_feature")) {
            var error = $root.NullableString.verify(message._feature);
            if (error)
                return "_feature." + error;
        }
        return null;
    };
    ...
    SDKVariable_PB.fromObject = function fromObject(object) {
        ...
        if (object._feature != null) {
            if (typeof object._feature !== "object")
                throw TypeError(".SDKVariable_PB._feature: object expected");
            message._feature = $root.NullableString.fromObject(object._feature);
        }
        return message;
    };
    ...
    SDKVariable_PB.toObject = function toObject(message, options) {
        ...
        if (message._feature != null && message.hasOwnProperty("_feature"))
            object._feature = $root.NullableString.toObject(message._feature, options);
        return object;
    };
...
$root.SDKVariableWithEval_PB = (function() {

    /**
     * Properties of a SDKVariableWithEval_PB.
     * @exports ISDKVariableWithEval_PB
     * @interface ISDKVariableWithEval_PB
     * @property {string|null} [_id] SDKVariableWithEval_PB _id
     * @property {VariableType_PB|null} [type] SDKVariableWithEval_PB type
     * @property {string|null} [key] SDKVariableWithEval_PB key
     * @property {boolean|null} [boolValue] SDKVariableWithEval_PB boolValue
     * @property {number|null} [doubleValue] SDKVariableWithEval_PB doubleValue
     * @property {string|null} [stringValue] SDKVariableWithEval_PB stringValue
     * @property {INullableString|null} [evalReason] SDKVariableWithEval_PB evalReason
     * @property {INullableString|null} [_feature] SDKVariableWithEval_PB _feature
     * @property {IEvalReason_PB|null} ["eval"] SDKVariableWithEval_PB eval
     */

    /**
     * Constructs a new SDKVariableWithEval_PB.
     * @exports SDKVariableWithEval_PB
     * @classdesc Represents a SDKVariableWithEval_PB.
     * @implements ISDKVariableWithEval_PB
     * @constructor
     * @param {ISDKVariableWithEval_PB=} [properties] Properties to set
     */
    function SDKVariableWithEval_PB(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
    ...
    /**
     * SDKVariableWithEval_PB _id.
     * @member {string} _id
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype._id = "";

    /**
     * SDKVariableWithEval_PB type.
     * @member {VariableType_PB} type
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype.type = 0;

    /**
     * SDKVariableWithEval_PB key.
     * @member {string} key
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype.key = "";

    /**
     * SDKVariableWithEval_PB boolValue.
     * @member {boolean} boolValue
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype.boolValue = false;

    /**
     * SDKVariableWithEval_PB doubleValue.
     * @member {number} doubleValue
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype.doubleValue = 0;

    /**
     * SDKVariableWithEval_PB stringValue.
     * @member {string} stringValue
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype.stringValue = "";

    /**
     * SDKVariableWithEval_PB evalReason.
     * @member {INullableString|null|undefined} evalReason
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype.evalReason = null;

    /**
     * SDKVariableWithEval_PB _feature.
     * @member {INullableString|null|undefined} _feature
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype._feature = null;

    /**
     * SDKVariableWithEval_PB eval.
     * @member {IEvalReason_PB|null|undefined} eval
     * @memberof SDKVariableWithEval_PB
     * @instance
     */
    SDKVariableWithEval_PB.prototype["eval"] = null;

    /**
     * Creates a new SDKVariableWithEval_PB instance using the specified properties.
     * @function create
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {ISDKVariableWithEval_PB=} [properties] Properties to set
     * @returns {SDKVariableWithEval_PB} SDKVariableWithEval_PB instance
     */
    SDKVariableWithEval_PB.create = function create(properties) {
        return new SDKVariableWithEval_PB(properties);
    };

    /**
     * Encodes the specified SDKVariableWithEval_PB message. Does not implicitly {@link SDKVariableWithEval_PB.verify|verify} messages.
     * @function encode
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {ISDKVariableWithEval_PB} message SDKVariableWithEval_PB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    SDKVariableWithEval_PB.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message._id != null && Object.hasOwnProperty.call(message, "_id"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message._id);
        ...
        if (message["eval"] != null && Object.hasOwnProperty.call(message, "eval"))
            $root.EvalReason_PB.encode(message["eval"], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
        return writer;
    };

    /**
     * Encodes the specified SDKVariableWithEval_PB message, length delimited. Does not implicitly {@link SDKVariableWithEval_PB.verify|verify} messages.
     * @function encodeDelimited
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {ISDKVariableWithEval_PB} message SDKVariableWithEval_PB message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SDKVariableWithEval_PB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a SDKVariableWithEval_PB message from the specified reader or buffer.
     * @function decode
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {SDKVariableWithEval_PB} SDKVariableWithEval_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SDKVariableWithEval_PB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SDKVariableWithEval_PB();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 9: {
                    message["eval"] = $root.EvalReason_PB.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    /**
     * Decodes a SDKVariableWithEval_PB message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SDKVariableWithEval_PB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a SDKVariableWithEval_PB message.
     * @function verify
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    SDKVariableWithEval_PB.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message._id != null && message.hasOwnProperty("_id"))
            if (!$util.isString(message._id))
        ...
        if (message["eval"] != null && message.hasOwnProperty("eval")) {
            var error = $root.EvalReason_PB.verify(message["eval"]);
            if (error)
                return "eval." + error;
        }
        return null;
    ...
    /**
     * Creates a SDKVariableWithEval_PB message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {SDKVariableWithEval_PB} SDKVariableWithEval_PB
     */
    SDKVariableWithEval_PB.fromObject = function fromObject(object) {
        if (object instanceof $root.SDKVariableWithEval_PB)
            return object;
        var message = new $root.SDKVariableWithEval_PB();
        if (object._id != null)
            message._id = String(object._id);
        switch (object.type) {
        default:
        ...
        if (object.evalReason != null) {
            if (typeof object.evalReason !== "object")
                throw TypeError(".SDKVariableWithEval_PB.evalReason: object expected");
            message.evalReason = $root.NullableString.fromObject(object.evalReason);
        }
        if (object._feature != null) {
            if (typeof object._feature !== "object")
                throw TypeError(".SDKVariableWithEval_PB._feature: object expected");
            message._feature = $root.NullableString.fromObject(object._feature);
        }
        if (object["eval"] != null) {
            if (typeof object["eval"] !== "object")
                throw TypeError(".SDKVariableWithEval_PB.eval: object expected");
            message["eval"] = $root.EvalReason_PB.fromObject(object["eval"]);
        }
        return message;
    };

    /**
     * Creates a plain object from a SDKVariableWithEval_PB message. Also converts values to other types if specified.
     * @function toObject
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {SDKVariableWithEval_PB} message SDKVariableWithEval_PB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    SDKVariableWithEval_PB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
        ...
        if (message._feature != null && message.hasOwnProperty("_feature"))
            object._feature = $root.NullableString.toObject(message._feature, options);
        if (message["eval"] != null && message.hasOwnProperty("eval"))
            object["eval"] = $root.EvalReason_PB.toObject(message["eval"], options);
        return object;
    };

    /**
     * Converts this SDKVariableWithEval_PB to JSON.
     * @function toJSON
     * @memberof SDKVariableWithEval_PB
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    SDKVariableWithEval_PB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    /**
     * Gets the default type url for SDKVariableWithEval_PB
     * @function getTypeUrl
     * @memberof SDKVariableWithEval_PB
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    SDKVariableWithEval_PB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/SDKVariableWithEval_PB";
    };

    return SDKVariableWithEval_PB;
})();

$root.SDKVariableWithEval_Flat_PB = (function() {

    /**
     * Properties of a SDKVariableWithEval_Flat_PB.
     * @exports ISDKVariableWithEval_Flat_PB
     * @interface ISDKVariableWithEval_Flat_PB
     * @property {string|null} [_id] SDKVariableWithEval_Flat_PB _id
     * @property {VariableType_PB|null} [type] SDKVariableWithEval_Flat_PB type
     * @property {string|null} [key] SDKVariableWithEval_Flat_PB key
     * @property {boolean|null} [boolValue] SDKVariableWithEval_Flat_PB boolValue
     * @property {number|null} [doubleValue] SDKVariableWithEval_Flat_PB doubleValue
     * @property {string|null} [stringValue] SDKVariableWithEval_Flat_PB stringValue
     * @property {INullableString|null} [evalReason] SDKVariableWithEval_Flat_PB evalReason
     * @property {INullableString|null} [_feature] SDKVariableWithEval_Flat_PB _feature
     * @property {string|null} [evalReason2] SDKVariableWithEval_Flat_PB evalReason2
     * @property {string|null} [evalDetails] SDKVariableWithEval_Flat_PB evalDetails
     * @property {string|null} [evalTargetId] SDKVariableWithEval_Flat_PB evalTargetId
     */

    /**
     * Constructs a new SDKVariableWithEval_Flat_PB.
     * @exports SDKVariableWithEval_Flat_PB
     * @classdesc Represents a SDKVariableWithEval_Flat_PB.
     * @implements ISDKVariableWithEval_Flat_PB
     * @constructor
     * @param {ISDKVariableWithEval_Flat_PB=} [properties] Properties to set
     */
    function SDKVariableWithEval_Flat_PB(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
    ...
    /**
     * SDKVariableWithEval_Flat_PB _id.
     * @member {string} _id
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype._id = "";

    /**
     * SDKVariableWithEval_Flat_PB type.
     * @member {VariableType_PB} type
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.type = 0;

    /**
     * SDKVariableWithEval_Flat_PB key.
     * @member {string} key
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.key = "";

    /**
     * SDKVariableWithEval_Flat_PB boolValue.
     * @member {boolean} boolValue
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.boolValue = false;

    /**
     * SDKVariableWithEval_Flat_PB doubleValue.
     * @member {number} doubleValue
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.doubleValue = 0;

    /**
     * SDKVariableWithEval_Flat_PB stringValue.
     * @member {string} stringValue
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.stringValue = "";

    /**
     * SDKVariableWithEval_Flat_PB evalReason.
     * @member {INullableString|null|undefined} evalReason
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.evalReason = null;

    /**
     * SDKVariableWithEval_Flat_PB _feature.
     * @member {INullableString|null|undefined} _feature
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype._feature = null;

    /**
     * SDKVariableWithEval_Flat_PB evalReason2.
     * @member {string} evalReason2
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.evalReason2 = "";

    /**
     * SDKVariableWithEval_Flat_PB evalDetails.
     * @member {string} evalDetails
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.evalDetails = "";

    /**
     * SDKVariableWithEval_Flat_PB evalTargetId.
     * @member {string} evalTargetId
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     */
    SDKVariableWithEval_Flat_PB.prototype.evalTargetId = "";

    /**
     * Creates a new SDKVariableWithEval_Flat_PB instance using the specified properties.
     * @function create
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {ISDKVariableWithEval_Flat_PB=} [properties] Properties to set
     * @returns {SDKVariableWithEval_Flat_PB} SDKVariableWithEval_Flat_PB instance
     */
    SDKVariableWithEval_Flat_PB.create = function create(properties) {
        return new SDKVariableWithEval_Flat_PB(properties);
    };

    /**
     * Encodes the specified SDKVariableWithEval_Flat_PB message. Does not implicitly {@link SDKVariableWithEval_Flat_PB.verify|verify} messages.
     * @function encode
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {ISDKVariableWithEval_Flat_PB} message SDKVariableWithEval_Flat_PB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    SDKVariableWithEval_Flat_PB.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message._id != null && Object.hasOwnProperty.call(message, "_id"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message._id);
        ...
        if (message._feature != null && Object.hasOwnProperty.call(message, "_feature"))
            $root.NullableString.encode(message._feature, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
        if (message.evalReason2 != null && Object.hasOwnProperty.call(message, "evalReason2"))
            writer.uint32(/* id 9, wireType 2 =*/74).string(message.evalReason2);
        if (message.evalDetails != null && Object.hasOwnProperty.call(message, "evalDetails"))
            writer.uint32(/* id 10, wireType 2 =*/82).string(message.evalDetails);
        if (message.evalTargetId != null && Object.hasOwnProperty.call(message, "evalTargetId"))
            writer.uint32(/* id 11, wireType 2 =*/90).string(message.evalTargetId);
        return writer;
    };

    /**
     * Encodes the specified SDKVariableWithEval_Flat_PB message, length delimited. Does not implicitly {@link SDKVariableWithEval_Flat_PB.verify|verify} messages.
     * @function encodeDelimited
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {ISDKVariableWithEval_Flat_PB} message SDKVariableWithEval_Flat_PB message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SDKVariableWithEval_Flat_PB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a SDKVariableWithEval_Flat_PB message from the specified reader or buffer.
     * @function decode
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {SDKVariableWithEval_Flat_PB} SDKVariableWithEval_Flat_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SDKVariableWithEval_Flat_PB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SDKVariableWithEval_Flat_PB();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    /**
     * Decodes a SDKVariableWithEval_Flat_PB message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SDKVariableWithEval_Flat_PB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a SDKVariableWithEval_Flat_PB message.
     * @function verify
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    SDKVariableWithEval_Flat_PB.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message._id != null && message.hasOwnProperty("_id"))
            if (!$util.isString(message._id))
        ...
        if (message.evalReason2 != null && message.hasOwnProperty("evalReason2"))
            if (!$util.isString(message.evalReason2))
                return "evalReason2: string expected";
        if (message.evalDetails != null && message.hasOwnProperty("evalDetails"))
            if (!$util.isString(message.evalDetails))
                return "evalDetails: string expected";
        if (message.evalTargetId != null && message.hasOwnProperty("evalTargetId"))
            if (!$util.isString(message.evalTargetId))
                return "evalTargetId: string expected";
        return null;
    };

    /**
     * Creates a SDKVariableWithEval_Flat_PB message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {SDKVariableWithEval_Flat_PB} SDKVariableWithEval_Flat_PB
     */
    SDKVariableWithEval_Flat_PB.fromObject = function fromObject(object) {
        if (object instanceof $root.SDKVariableWithEval_Flat_PB)
            return object;
        var message = new $root.SDKVariableWithEval_Flat_PB();
        if (object._id != null)
            message._id = String(object._id);
        switch (object.type) {
        default:
        ...
        if (object.evalReason != null) {
            if (typeof object.evalReason !== "object")
                throw TypeError(".SDKVariableWithEval_Flat_PB.evalReason: object expected");
            message.evalReason = $root.NullableString.fromObject(object.evalReason);
        }
        if (object._feature != null) {
            if (typeof object._feature !== "object")
                throw TypeError(".SDKVariableWithEval_Flat_PB._feature: object expected");
            message._feature = $root.NullableString.fromObject(object._feature);
        }
        if (object.evalReason2 != null)
            message.evalReason2 = String(object.evalReason2);
        if (object.evalDetails != null)
            message.evalDetails = String(object.evalDetails);
        if (object.evalTargetId != null)
            message.evalTargetId = String(object.evalTargetId);
        return message;
    };

    /**
     * Creates a plain object from a SDKVariableWithEval_Flat_PB message. Also converts values to other types if specified.
     * @function toObject
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {SDKVariableWithEval_Flat_PB} message SDKVariableWithEval_Flat_PB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    SDKVariableWithEval_Flat_PB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
        ...
        if (message._feature != null && message.hasOwnProperty("_feature"))
            object._feature = $root.NullableString.toObject(message._feature, options);
        if (message.evalReason2 != null && message.hasOwnProperty("evalReason2"))
            object.evalReason2 = message.evalReason2;
        if (message.evalDetails != null && message.hasOwnProperty("evalDetails"))
            object.evalDetails = message.evalDetails;
        if (message.evalTargetId != null && message.hasOwnProperty("evalTargetId"))
            object.evalTargetId = message.evalTargetId;
        return object;
    };

    /**
     * Converts this SDKVariableWithEval_Flat_PB to JSON.
     * @function toJSON
     * @memberof SDKVariableWithEval_Flat_PB
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    SDKVariableWithEval_Flat_PB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    /**
     * Gets the default type url for SDKVariableWithEval_Flat_PB
     * @function getTypeUrl
     * @memberof SDKVariableWithEval_Flat_PB
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    SDKVariableWithEval_Flat_PB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/SDKVariableWithEval_Flat_PB";
    };

    return SDKVariableWithEval_Flat_PB;
})();

$root.EvalReason_PB = (function() {

    /**
     * Properties of an EvalReason_PB.
     * @exports IEvalReason_PB
     * @interface IEvalReason_PB
     * @property {string|null} [reason] EvalReason_PB reason
     * @property {string|null} [details] EvalReason_PB details
     * @property {string|null} [target_id] EvalReason_PB target_id
     */

    /**
     * Constructs a new EvalReason_PB.
     * @exports EvalReason_PB
     * @classdesc Represents an EvalReason_PB.
     * @implements IEvalReason_PB
     * @constructor
     * @param {IEvalReason_PB=} [properties] Properties to set
     */
    function EvalReason_PB(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @memberof EvalReason_PB
     * @instance
     */
    EvalReason_PB.prototype.reason = "";
     ...
     * @instance
     */
    EvalReason_PB.prototype.details = "";
     ...
     * @instance
     */
    EvalReason_PB.prototype.target_id = "";
     ...
     * @static
     * @param {IEvalReason_PB=} [properties] Properties to set
     * @returns {EvalReason_PB} EvalReason_PB instance
     */
    EvalReason_PB.create = function create(properties) {
        return new EvalReason_PB(properties);
    };
     ...
     * @memberof EvalReason_PB
     * @static
     * @param {IEvalReason_PB} message EvalReason_PB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    EvalReason_PB.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
     ...
     * @returns {$protobuf.Writer} Writer
     */
    EvalReason_PB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {EvalReason_PB} EvalReason_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    EvalReason_PB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.EvalReason_PB();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    EvalReason_PB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    EvalReason_PB.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
     ...
     * @returns {EvalReason_PB} EvalReason_PB
     */
    EvalReason_PB.fromObject = function fromObject(object) {
        if (object instanceof $root.EvalReason_PB)
            return object;
        var message = new $root.EvalReason_PB();
     ...
     * @memberof EvalReason_PB
     * @static
     * @param {EvalReason_PB} message EvalReason_PB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    EvalReason_PB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
     ...
     * @returns {Object.<string,*>} JSON object
     */
    EvalReason_PB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    EvalReason_PB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/EvalReason_PB";
    };

    return EvalReason_PB;
})();
