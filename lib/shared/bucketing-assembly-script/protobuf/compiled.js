...
$root.EvalReason_PB = (function() {
     ...
     * @property {string|null} [evalReason] EvalReason_PB evalReason
     * @property {string|null} [evalDetails] EvalReason_PB evalDetails
     * @property {string|null} [evalTargetId] EvalReason_PB evalTargetId
     */
    ...
    /**
     * EvalReason_PB evalReason.
     * @member {string} evalReason
     * @memberof EvalReason_PB
     * @instance
     */
    EvalReason_PB.prototype.evalReason = "";

    /**
     * EvalReason_PB evalDetails.
     * @member {string} evalDetails
     * @memberof EvalReason_PB
     * @instance
     */
    EvalReason_PB.prototype.evalDetails = "";

    /**
     * EvalReason_PB evalTargetId.
     * @member {string} evalTargetId
     * @memberof EvalReason_PB
     * @instance
     */
    EvalReason_PB.prototype.evalTargetId = "";
    ...
    EvalReason_PB.encode = function encode(message, writer) {
        ...
        if (message.evalReason != null && Object.hasOwnProperty.call(message, "evalReason"))
            writer.uint32(/* id 9, wireType 2 =*/74).string(message.evalReason);
    ...
    EvalReason_PB.verify = function verify(message) {
        ...
        if (message.evalReason != null && message.hasOwnProperty("evalReason"))
            if (!$util.isString(message.evalReason))
                return "evalReason: string expected";
    ...
    EvalReason_PB.fromObject = function fromObject(object) {
        ...
        if (object.evalReason != null)
            message.evalReason = String(object.evalReason);
    ...
    EvalReason_PB.toObject = function toObject(message, options) {
        ...
        if (message.evalReason != null && message.hasOwnProperty("evalReason"))
            object.evalReason = message.evalReason;
        if (message.evalDetails != null && message.hasOwnProperty("evalDetails"))
