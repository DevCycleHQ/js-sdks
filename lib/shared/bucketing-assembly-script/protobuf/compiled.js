...
$root.NullableString = (function() {
     ...
     */
    NullableString.decode = function decode(reader, length, error) {
...
$root.NullableDouble = (function() {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NullableDouble.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
...
$root.CustomDataValue = (function() {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    CustomDataValue.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
...
$root.NullableCustomData = (function() {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NullableCustomData.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
...
$root.VariableForUserParams_PB = (function() {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    VariableForUserParams_PB.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
...
$root.DVCUser_PB = (function() {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DVCUser_PB.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
...
$root.SDKVariable_PB = (function() {
     ...
     * @property {IEvalReason_PB|null} [evalReason] SDKVariable_PB evalReason
     ...
     * @member {IEvalReason_PB|null|undefined} evalReason
     * @memberof SDKVariable_PB
     * @instance
     */
    ...
    SDKVariable_PB.encode = function encode(message, writer) {
        ...
        if (message.evalReason != null && Object.hasOwnProperty.call(message, "evalReason"))
            $root.EvalReason_PB.encode(message.evalReason, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SDKVariable_PB.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        ...
        while (reader.pos < end) {
            ...
            case 7: {
                    message.evalReason = $root.EvalReason_PB.decode(reader, reader.uint32());
                    break;
                }
            case 8: {
    ...
    SDKVariable_PB.verify = function verify(message) {
        ...
        if (message.evalReason != null && message.hasOwnProperty("evalReason")) {
            var error = $root.EvalReason_PB.verify(message.evalReason);
            if (error)
    ...
    SDKVariable_PB.fromObject = function fromObject(object) {
        ...
        if (object.evalReason != null) {
            ...
            message.evalReason = $root.EvalReason_PB.fromObject(object.evalReason);
        }
    ...
    SDKVariable_PB.toObject = function toObject(message, options) {
        ...
        if (message.stringValue != null && message.hasOwnProperty("stringValue"))
            object.stringValue = message.stringValue;
        if (message.evalReason != null && message.hasOwnProperty("evalReason"))
            object.evalReason = $root.EvalReason_PB.toObject(message.evalReason, options);
        if (message._feature != null && message.hasOwnProperty("_feature"))
...
$root.EvalReason_PB = (function() {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    EvalReason_PB.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
