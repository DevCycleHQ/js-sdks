...
/** Represents a SDKVariableWithEval_PB. */
export class SDKVariableWithEval_PB implements ISDKVariableWithEval_PB {

    /**
     * Constructs a new SDKVariableWithEval_PB.
     * @param [properties] Properties to set
     */
    constructor(properties?: ISDKVariableWithEval_PB);
     ...
     * @param [properties] Properties to set
     * @returns SDKVariableWithEval_PB instance
     */
    public static create(properties?: ISDKVariableWithEval_PB): SDKVariableWithEval_PB;
     ...
     * @param message SDKVariableWithEval_PB message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: ISDKVariableWithEval_PB, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: ISDKVariableWithEval_PB, writer?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a SDKVariableWithEval_PB message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns SDKVariableWithEval_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): SDKVariableWithEval_PB;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): SDKVariableWithEval_PB;
     ...
     * @returns SDKVariableWithEval_PB
     */
    public static fromObject(object: { [k: string]: any }): SDKVariableWithEval_PB;

    /**
     * Creates a plain object from a SDKVariableWithEval_PB message. Also converts values to other types if specified.
     * @param message SDKVariableWithEval_PB
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: SDKVariableWithEval_PB, options?: $protobuf.IConversionOptions): { [k: string]: any };
...
/** Represents a SDKVariableWithEval_Flat_PB. */
export class SDKVariableWithEval_Flat_PB implements ISDKVariableWithEval_Flat_PB {

    /**
     * Constructs a new SDKVariableWithEval_Flat_PB.
     * @param [properties] Properties to set
     */
    constructor(properties?: ISDKVariableWithEval_Flat_PB);
    ...
    public evalReason2: string;

    /** SDKVariableWithEval_Flat_PB evalDetails. */
    public evalDetails: string;

    /** SDKVariableWithEval_Flat_PB evalTargetId. */
    public evalTargetId: string;

    /**
     * Creates a new SDKVariableWithEval_Flat_PB instance using the specified properties.
     * @param [properties] Properties to set
     * @returns SDKVariableWithEval_Flat_PB instance
     */
    public static create(properties?: ISDKVariableWithEval_Flat_PB): SDKVariableWithEval_Flat_PB;
     ...
     * @param message SDKVariableWithEval_Flat_PB message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: ISDKVariableWithEval_Flat_PB, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: ISDKVariableWithEval_Flat_PB, writer?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a SDKVariableWithEval_Flat_PB message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns SDKVariableWithEval_Flat_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): SDKVariableWithEval_Flat_PB;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): SDKVariableWithEval_Flat_PB;
     ...
     * @returns SDKVariableWithEval_Flat_PB
     */
    public static fromObject(object: { [k: string]: any }): SDKVariableWithEval_Flat_PB;

    /**
     * Creates a plain object from a SDKVariableWithEval_Flat_PB message. Also converts values to other types if specified.
     * @param message SDKVariableWithEval_Flat_PB
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: SDKVariableWithEval_Flat_PB, options?: $protobuf.IConversionOptions): { [k: string]: any };
