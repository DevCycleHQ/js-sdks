...
/** Represents a ClientCustomData_PB. */
export class ClientCustomData_PB implements IClientCustomData_PB {

    /**
     * Constructs a new ClientCustomData_PB.
     * @param [properties] Properties to set
     */
    constructor(properties?: IClientCustomData_PB);
     ...
     * @param [properties] Properties to set
     * @returns ClientCustomData_PB instance
     */
    public static create(properties?: IClientCustomData_PB): ClientCustomData_PB;

    /**
     * Encodes the specified ClientCustomData_PB message. Does not implicitly {@link ClientCustomData_PB.verify|verify} messages.
     * @param message ClientCustomData_PB message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: IClientCustomData_PB, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: IClientCustomData_PB, writer?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a ClientCustomData_PB message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns ClientCustomData_PB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ClientCustomData_PB;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ClientCustomData_PB;
     ...
     * @returns ClientCustomData_PB
     */
    public static fromObject(object: { [k: string]: any }): ClientCustomData_PB;

    /**
     * Creates a plain object from a ClientCustomData_PB message. Also converts values to other types if specified.
     * @param message ClientCustomData_PB
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: ClientCustomData_PB, options?: $protobuf.IConversionOptions): { [k: string]: any };
