...
describe('DevCycleCloudClient', () => {
    ...
    describe('without EdgeDB', () => {
        ...
        describe('track', () => {
            ...
            it('throws an error for a null event', async () => {
                const badEvent = null
                await expect(
                    async () =>
                        await client.track(
            ...
            it('throws an error for a undefined event', async () => {
            ...
            it('throws an error for an event with no type', async () => {
    ...
    describe('with EdgeDB', () => {
        ...
        describe('allVariables', () => {
            ...
            it('throws exception when allVariables called with invalid user', async () => {
                await expect(client.allVariables(badUser)).rejects.toThrow(
                    'DevCycle request failed with status 400.',
                )
            })
        ...
        describe('allFeatures', () => {
            ...
            it('throws exception when allFeatures called with invalid user', async () => {
                await expect(client.allFeatures(badUser)).rejects.toThrow(
                    'DevCycle request failed with status 400.',
                )
            })
