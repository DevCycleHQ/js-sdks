...
describe('paramUtils Unit Tests', () => {
  ...
  describe('checkParamType', () => {
    ...
    it('should throw for undefined param', () => {
      expect(() => checkParamType('param', null, typeEnum.string)).toThrow(
        'param is invalid!',
      )
    })
    ...
    it('should throw if param type is not correct', () => {
      ...
      expect(() => checkParamType('param', 'string', typeEnum.number)).toThrow(
        'param is not of type: number',
      )
      expect(() => checkParamType('param', 'string', typeEnum.boolean)).toThrow(
        'param is not of type: boolean',
      )
    })
