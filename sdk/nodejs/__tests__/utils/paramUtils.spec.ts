import { checkParamDefined, checkParamType, typeEnum } from '../../src/utils/paramUtils'
...
describe('paramUtils Unit Tests', () => {
    ...
    describe('checkParamType', () => {
        ...
        it('should throw for undefined param', () => {
            expect(() => checkParamType('param', null, typeEnum.string)).toThrow('param is invalid!')
        })

        it('should throw if param type is not correct', () => {
            expect(() => checkParamType('param', 6, typeEnum.string)).toThrow('param is not of type: string')
            expect(() => checkParamType('param', 'string', typeEnum.number)).toThrow('param is not of type: number')
            expect(() => checkParamType('param', 'string', typeEnum.boolean)).toThrow('param is not of type: boolean')
        })
        ...
        it('should throw for empty string', () => {
            expect(() => checkParamType('param', '', typeEnum.string)).toThrow('param is invalid string!')
        })

        it('should throw for NaN', () => {
            expect(() => checkParamType('param', NaN, typeEnum.number)).toThrow('param is invalid number!')
        })
    })
})
