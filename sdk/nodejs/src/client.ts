...
import {
    bucketUserForConfig, getVariableTypeCode, variableForUser, variableForUser_PB
...
export class DVCClient {
    ...
    variable<T extends DVCVariableValue>(user: DVCUser, key: string, defaultValue: T): DVCVariable<T> {
        ...
        // console.log(`configVariable: ${configVariable ? JSON.stringify(configVariable) : 'null'}`)
