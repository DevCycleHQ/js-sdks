declare module 'dvc-js-client-sdk' {
    ...
    export interface DVCClient {
        ...
        /**
         * Notify the user when Features have been loaded from the server. An optional callback can be passed in, and will return
         ...
         * DVCVariable is returned, which has a value property that is used to grab the variable value, and a convenience method
         * to pass in a callback to notify the user when the value has changed from the server.
         *
         * @param key
         * @param defaultValue
         */
        ...
        identifyUser(
            user: DVCUser,
            callback?: (err: Error | null, variables: DVCVariableSet) => void
