...
describe('DVCVariable tests', () => {
    it('should throw error if no key or default value', () => {
        const noKey = () =>
            new DVCVariable({ key: undefined, defaultValue: 'default' } as any)
    ...
    it('should throw error if key is not a string', () => {
        const keyNotString = () =>
            new DVCVariable({ key: 4 as any, defaultValue: 'default' })
    ...
    it('should create a DVCVariable from object', () => {
        const variable = new DVCVariable({
            ...
            eval: {
                reason: 'SPLIT',
                details: 'Rollout | All Users',
                target_id: 'test_rollout_id',
            },
        } as any)
