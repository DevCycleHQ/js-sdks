...
import {
  ...
  useVariable,
  withDVCProvider,
} from '@devcycle/devcycle-react-native-sdk'
...
export const App = (): JSX.Element => {
  ...
  if (!dvcReady)
    return (
      <SafeAreaView>
        <Text style={styles.textXL}>DVC is not ready!</Text>
      </SafeAreaView>
    )
        ...
        >
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.textLg}>
              My device:{' '}
              <Text style={styles.textBold}>{DeviceInfo.getModel()}</Text>{' '}
              {'\n'}
              The value for <Text style={styles.textBold}>
                {VARIABLE_KEY}
              </Text>{' '}
              is
            ...
            <TouchableOpacity
              ...
              onPress={() => resetUser()}
            >
              <Text style={[styles.textMd, styles.textCenter]}>Reset User</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.whatsNextButton}
          ...
          <View style={styles.section}>
            <Text style={styles.textMd}>{JSON.stringify(variables)}</Text>
          </View>
          <View style={styles.section}>
